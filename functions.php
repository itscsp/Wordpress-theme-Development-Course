...
function university_files() {
  ...
  wp_localize_script('main-university-js', 'univercityData', array(
...
//Redirect subscriber account out of admin dashboard and onto homepage
...
//Remove top admin bar from normol user
